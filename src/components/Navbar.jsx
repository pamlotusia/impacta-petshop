...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-20 flex justify-between items-center text-white bg-[#0A082E] font-poppins px-20">
      ...
      <div className="lg:hidden flex-items-center">
        ...
        {isMenuOpen && (
          <ul className="flex flex-col items-end p-8 bg-[#0A082E] absolute top-0 right-0 h-full">
